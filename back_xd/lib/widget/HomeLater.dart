...
class HomeLater extends StatelessWidget {
  HomeLater({
    required Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: -335.0, end: -2.0),
            Pin(size: 1014.0, end: 1.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 332.0, end: 2.0),
                  Pin(size: 144.0, start: 146.0),
                  child: SvgPicture.string(
                    _svg_nqxqkf,
                    allowDrawingOutsideViewBox: true,
                    fit: BoxFit.fill,
                ...
                Pinned.fromPins(
                  Pin(size: 97.0, end: 50.0),
                  Pin(size: 55.0, middle: 0.1971),
                  child: Text(
                    'Later',
                    style: TextStyle(
                      fontFamily: 'Roboto',
                ...
                Align(
                  alignment: Alignment(0.669, -0.607),
                  child: SizedBox(
                    width: 62.0,
                    height: 62.0,
                    child: Stack(
...
const String _svg_nqxqkf =
    '<svg viewBox="748.0 1156.0 332.0 144.0" ><path transform="translate(748.0, 1156.0)" d="M 0 0 L 332 0 L 332 144 L 0 144 L 0 0 Z" fill="#fc5565" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
