...
class LaterTask extends StatelessWidget {
  LaterTask({
    required Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            child: Stack(
              children: <Widget>[
                ...
                Align(
                  alignment: Alignment(-0.602, -0.029),
                  child: SizedBox(
                    width: 236.0,
                    height: 63.0,
                    child: Text(
          ...
          Pinned.fromPins(
            ...
            Pin(size: 1542.0, end: 1.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
                  Pin(size: 144.0, start: 48.0),
                  child: Stack(
                    children: <Widget>[
                      Container(
                        decoration: BoxDecoration(
...
const String _svg_ndruav =
    '<svg viewBox="864.0 441.0 216.0 48.0" ><path transform="translate(915.0, 441.0)" d="M -50.99999618530273 0 L 165 0 L 165 48 L -9.741571426391602 48 C -9.741571426391602 48 -50.99999618530273 0 -50.99999618530273 0 L -50.99999618530273 0 Z" fill="#fc5565" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_l89pk =
    '<svg viewBox="792.0 1068.0 288.0 48.0" ><path transform="translate(843.0, 1068.0)" d="M -51 0 L 237 0 L 237 48 L 4.011236190795898 48 C 4.011236190795898 48 -51 0 -51 0 L -51 0 Z" fill="#fc5565" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_q49zw6 =
    '<svg viewBox="864.0 1664.0 216.0 48.0" ><path transform="translate(915.0, 1664.0)" d="M -51 0 L 165 0 L 165 48 L -9.741573333740234 48 C -9.741573333740234 48 -51 0 -51 0 L -51 0 Z" fill="#f54439" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
